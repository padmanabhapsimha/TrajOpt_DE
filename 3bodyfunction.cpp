...
//        Ephem_obj.JPL_equatorial_m_get(julianstart+t/86400.0,secbody,pribody,state,0);///moon to earth
...
//        dxdt.at(3)=-(mu_s*x/r3)-(mu_p*(xxp)/rrp3)-(mu_p*xp/rp3)+ax;
//        dxdt.at(4)=-(mu_s*y/r3)-(mu_p*(yyp)/rrp3)-(mu_p*yp/rp3)+ay;
//        dxdt.at(5)=-(mu_s*z/r3)-(mu_p*(zzp)/rrp3)-(mu_p*zp/rp3)+az;
...
//        lx=xstate.at(7);ly=xstate.at(8);lz=xstate.at(9);lvx=xstate.at(10);lvy=xstate.at(11);lvz=xstate.at(12);lm=xstate.at(13);
//        r=sqrt(sqr(x)+sqr(y)+sqr(z));r3=cube(r);r4=r3*r;
//        Ephem_obj.JPL_equatorial_m_get(julianstart+t/86400.0,pribody,secbody,state,0);
...
//    /// ///////////////////////////////////////////////////////////////////////////////
//    Ephem_obj.JPL_equatorial_m_get(julianstart,secbody,pribody,state,1);
...
//    /// ///////////////////////////////////////////////////////////////////////////////
//    /// INTEGRATION ROUTINE
//    const double r_soi_sec=params.a_second*pow((params.mu_e/params.mu),0.4);
...
//            break;
//        }
////        Ephem_obj.JPL_equatorial_m_get(julianstart+t/86400.0,secbody,pribody,state,1);
////        xp=state.at(0);yp=state.at(1);zp=state.at(2);vxp=state.at(3);vyp=state.at(4);vzp=state.at(5);
...
//        dt=(r2p<1.75*r_soi_sec&&dt>1.0*8640.00*params.maxstep)?1.0*8640.00*params.maxstep:dt;
//    }
//    dt=endtime-t;
//    double dtlast=dt;
//    if(frameID==0){
...
//        controlled_stepper.try_step(rhs_helio,xstate,t,dt);
//        xfr1=xstate;xfr2=xfr1;
//        Ephem_obj.JPL_equatorial_m_get(julianstart+endtime/86400.0,secbody,pribody,state,1);
//        xp=state.at(0);yp=state.at(1);zp=state.at(2);vxp=state.at(3);vyp=state.at(4);vzp=state.at(5);
//        xfr2.at(0)-=xp;xfr2.at(1)-=yp;xfr2.at(2)-=zp;xfr2.at(3)-=vxp;xfr2.at(4)-=vyp;xfr2.at(5)-=vzp;
//    }
//    else if(frameID==1){
...
////    cost_val+=(sqr(ey-eyi));
////    cost_val+=(sqr(ez-ezi));
//    cost_val+=sqr(sqrt(sqr(exi)+sqr(eyi)+sqr(ezi))-sqrt(sqr(ex)+sqr(ey)+sqr(ez)));
//    cost_val+=sqr(incl-params.inclf)/pi;
//    massfrac=1.0-xstate.at(6)/mi;
//    r2p=sqrt(sqr(xfr2.at(0))+sqr(xfr2.at(1))+sqr(xfr2.at(2)));
//    double v2p=sqrt(sqr(xfr2.at(3))+sqr(xfr2.at(4))+sqr(xfr2.at(5)));
//    double energy=0.5*sqr(v2p)-mu/r2p;
//    double xp_m,yp_m,zp_m,vxp_m,vyp_m,vzp_m;
//    if(params.endbody==1){
//        Ephem_obj.JPL_equatorial_m_get(julianstart+endtime/86400.0,secbody,pribody,state_e,1);
...
////    double cost_val2=abs(sqr(xfr2.at(0))+sqr(xfr2.at(1))+sqr(xfr2.at(2))-sqr(r_soi_sec))/sqr(r_soi_sec);
